    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto grow flex flex-col">
        ...
        <div className="text-center mb-8">
          <h1
            className="font-bold text-white drop-shadow-lg mb-2"
            style={{ fontSize: "62px" }}
          >
            আমার রেশন
          </h1>
        ...
        {/* Login Cards */}
        <div
          className="flex justify-center items-center mx-auto mb-auto"
          style={{ gap: "48px" }}
        >
            ...
            >
              ...
              >
                ...
                <div style={{ width: "100%", marginBottom: "12px" }}>
                  <div
                    className="bg-white/90 backdrop-blur-sm text-[#16679c] rounded-lg hover:bg-white transition-colors duration-300 text-center font-semibold shadow-md"
                    style={{ padding: "10px 28px", fontSize: "17px" }}
                  >
                    লগইন করুন
                  </div>
                </div>
