...
const LOC_KHULNA = {
  ...
  district: "খুলনা",
  upazila: "কয়রা",
  unionName: "মহেশ্বরীপুর",
};
const LOC_CTGM = {
  division: "চট্টগ্রাম",
  district: "চট্টগ্রাম",
  upazila: "সীতাকুণ্ড",
  unionName: "বড় কুমিরা",
};
...
(async () => {
  ...
  try {
    ...
    const distUser2 = await User.create({
      ...
      contactEmail: "afisul02@gmail.com",
      passwordHash: distPass,
      status: "Active",
      tokenVersion: 0,
      mustChangePassword: false,
    ...
    const dist1 = await Distributor.create({
      ...
      wardNo: "01",
      ward: "01",
      loginEmail: distUser1.email,
      contactEmail: distUser1.contactEmail,
      authorityStatus: "Active",
      authorityFrom: new Date("2025-01-01"),
      authorityTo: new Date("2027-12-31"),
    });
    const dist2 = await Distributor.create({
      ...
      wardNo: "02",
      ward: "02",
      loginEmail: distUser2.email,
      contactEmail: distUser2.contactEmail,
      authorityStatus: "Active",
      authorityFrom: new Date("2025-01-01"),
      authorityTo: new Date("2027-12-31"),
    });
    const dist3 = await Distributor.create({
      ...
      wardNo: "03",
      ward: "03",
      loginEmail: distUser3.email,
      contactEmail: distUser3.contactEmail,
    ...
    const dist4 = await Distributor.create({
      ...
      wardNo: "04",
      ward: "04",
      loginEmail: distUser4.email,
      contactEmail: distUser4.contactEmail,
      authorityStatus: "Suspended",
      authorityFrom: new Date("2025-01-01"),
      authorityTo: new Date("2027-12-31"),
    });
