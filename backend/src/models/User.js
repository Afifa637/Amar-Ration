...
const UserSchema = new mongoose.Schema(
  {
    ...
    twoFactorSecretFingerprint: { type: String, select: false },
    twoFactorMismatch: { type: Boolean, default: false },
    twoFactorMismatchDetectedAt: { type: Date },
    failedLoginAttempts: { type: Number, default: 0 },
    lastFailedLoginAt: { type: Date },
    loginLockUntil: { type: Date },
    twoFactorFailedAttempts: { type: Number, default: 0 },
    twoFactorLastFailedAt: { type: Date },
